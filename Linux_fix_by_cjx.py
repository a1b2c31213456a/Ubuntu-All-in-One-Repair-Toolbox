...
def install_chinese_language():
    ...
    if result == 0:
        try:
            ...
            print('中文语言包设置完成！！！')
            print('若系统语言未更换成中文请重新启动计算机或执行 source ~/.bashrc 来应用更改(部分计算机必须重新启动！)')
...
def banben_by():
    """显示版本信息"""
    os.system('clear')
    print('程序版本:version 1.1')
    print('⚠ 注意：本应用只供研究使用，请在使用完成后自觉删除！若出现BUG请将错误信息发到邮箱：CCCLJX2014@Outlook.com\n\n2026年Python制作！本软件的诞生少不了linuxmirrors开源软件！！！')
    print('陈俊旭 出品')
